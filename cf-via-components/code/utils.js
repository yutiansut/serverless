...
// eveything which is returned in the `handlerWrapper` call will be put inside the
// `Data` object which in turn is presistent on AWS end in an S3 bucket AWS manages
...
module.exports = { Context, logger, extractInputs, extractState, response, handlerWrapper };
